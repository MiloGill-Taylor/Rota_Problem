...
class EditDoctorPage(tk.Frame):
    ...
    def display_content(self):
        ...
        for child in _list:
            child.destroy()
        headerLabel=ttk.Label(self, text = "Editing {} profile".format(self.old_name), font = constants.Large_font)
        ...
        delete_doctorButton=ttk.Button(self, text="Delete Doctor", command=lambda: self.destroy_doctor())
        ...
        delete_doctorButton.grid(row=11, column=1, pady=20)
        back_button.grid(row=11,pady=20, column=0)

    
        
    def set_current_doctor(self,doctor, old_name):
        self.current_doctor=doctor 
        self.old_name=old_name
        self.current_doctor.clear_attributes()
    
    def destroy_doctor(self):
        self.current_doctor.destroy_doctor()
